...
grass_img = pygame.image.load(os.path.join("pyrraria/assets", "grass.png"))
dirt_img = pygame.image.load(os.path.join("pyrraria/assets", "dirt.png"))
plant_img = pygame.image.load(os.path.join("pyrraria/assets", "plant.png")).convert()
plant_img.set_colorkey((255, 255, 255))

player_img = pygame.image.load(os.path.join("pyrraria/assets", "player.png")).convert()
...
display = pygame.Surface((300, 200))  # surface for rendering, which is scaled
...
def change_action(action_var, new_value):
